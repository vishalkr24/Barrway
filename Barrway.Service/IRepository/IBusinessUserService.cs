...
namespace Barrway.Service.IRepository
{
    public interface IBusinessUserService
    {
        ...
        Task<AddUpdateDelete> SendEmailInvite(BusinessUserInvitationModel inviteModel, IDictionary<string, object> userDetails);
        ...
        Task<bool> CheckAddtionalFormUserEntry(int formId, int createdId, string companyCode);
    }
}
