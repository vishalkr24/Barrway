        ...
        var columns = [
            {
                title: '', field: 'ACTION', formatter: function (cell, formatter) {
                    ...
                    return `<a href='/BusinessAdmin/SetupCompanyCalendar?CompanyId=${cell.getRow().getData().COMPANY_ID}&IsPartial=false&CalendarCode=${cell.getRow().getData().CALENDAR_CODE}' class="btn btn-primary text-light" style="border-radius:300px;">Edit</a>`;
                }, headerSort: false
            },
