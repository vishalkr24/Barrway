...
//this["FirechatDefaultTemplates"]["templates/message.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class=\'message message-' +__e( type ) +' '; if (isSelfMessage) { ;__p += ' message-self '; } ;__p += '\' data-message-id=\'' +__e( id ) +'\' data-user-id=\'' +__e( userId ) +'\' data-user-name=\'' +__e( name ) +'\' data-class="firechat-message">\n<div class=\'clearfix\'>\n<label class=\'fourfifth\'>\n'; if (!isSelfMessage) { ;__p += '<strong class=\'name\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</strong>'; } ;__p += '\n<em>(' +__e( localtime ) +')</em>:\n</label>\n<label class=\'fifth alignright\'>\n'; if (isSelfMessage) { ;__p += '\n<a href="javascript:;" class="editIcon"><img width="18px" src="' + assetsImagePath + '/edit.png" /></a>\n<a href="javascript:;" class="delteIcon"><img width="18px" src="' + assetsImagePath + '/delete.png" /></a>\n'; } ;__p += '\n'; if (!disableActions) { ;__p += '\n<a href=\'#!\' data-event=\'firechat-user-chat\' class=\'icon user-chat\' title=\'Invite to Private Chat\'>&nbsp;</a>\n<a href=\'#!\' data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute\' title=\'Mute User\'>&nbsp;</a>\n'; } ;__p += '\n</label>\n</div>\n<div class=\'clearfix message-content\'>\n' +((__t = ( message )) == null ? '' : __t) +'\n</div>\n</div>';}return __p};
this["FirechatDefaultTemplates"]["templates/message.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) { if (isSelfDeleted !='1' || !isSelfMessage) { ;__p += '\n<div class=\'message message-' +__e( type ) +' '; if (isSelfMessage || isSelfMessage=="true") { ;__p += ' message-self '; } ;__p += '\' data-message-id=\'' +__e( id ) +'\' data-message-status=\'' +__e( status ) +'\' data-user-id=\'' +__e( userId ) +'\' data-message-delete=\'' +__e( isSelfDeleted ) +'\' data-user-name=\'' +__e( name ) +'\' data-class="firechat-message" '; if (isSelfDeleted =='2') { ;__p += ' style="color:#333 !important" '; } ;__p += '>\n'; if (!isSelfMessage) { ;__p += '\n<div class=\'clearfix\'>\n<label class=\'fourfifth\'>\n<strong class=\'name\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</strong>\n<em>(' +__e( localtime ) +')</em>:\n</label>\n<label class=\'fifth alignright\'>\n'; if (!disableActions) { ;__p += '\n<a href=\'#!\' data-event=\'firechat-user-chat\' class=\'icon user-chat\' title=\'Invite to Private Chat\'>&nbsp;</a>\n<a href=\'#!\' data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute\' title=\'Mute User\'>&nbsp;</a>\n'; } ;__p += '\n</label>\n</div>\n'; } ; if (isSelfMessage) { ;__p += '\n<div class="clearfix">\n<label class=\'fourfifth\'>\n<label class=\'fifth alignleft\'>\n'; if (isSelfDeleted =='0' && type.indexOf("default") > -1) { ;__p += '\n<a href="javascript:;" class="editIcon"><img width="18px" src="' + assetsImagePath + '/edit.png" /></a>\n'; } ;__p += '\n<a href="javascript:;" class="delteIcon"><img width="18px" src="' + assetsImagePath + '/delete.png" /></a>\n'; if (!disableActions) { ;__p += '\n<a href=\'#!\' data-event=\'firechat-user-chat\' class=\'icon user-chat\' title=\'Invite to Private Chat\'>&nbsp;</a>\n<a href=\'#!\' data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute\' title=\'Mute User\'>&nbsp;</a>\n'; } ;__p += '\n</label>\n<strong class=\'name\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</strong>\n<em>(' +__e( localtime ) +')</em>:\n</label>\n</div>\n'; } ;__p += '\n<div class=\'clearfix message-content\'>\n'; if (isSelfDeleted =='2' || status =='Deleted') { ;__p += '\nThis message was deleted.\n'; }else { ;__p += '\n' +((__t = ( message )) == null ? '' : __t) +'\n'; } ;__p += '\n</div>\n</div>\n'; } ;}return __p};
...
this["FirechatDefaultTemplates"]["templates/prompt-message-edit.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<textarea>' +__e( message ) +'</textarea>\n<p class=\'clearfix\'>\n<button data-toggle=\'accept\' type=\'button\' class=\'btn\'>Update</button>\n<button data-toggle=\'decline\' type=\'button\' class=\'btn\'>Cancel</button>\n</p>\n</div>';}return __p};

//this["FirechatDefaultTemplates"]["templates/prompt-message-delete.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<p class=\'clearfix\'>\n<button data-toggle=\'accept_for_me\' type=\'button\' class=\'btn\'>Delete For Me</button>\n<button data-toggle=\'decline\' type=\'button\' class=\'btn\'>Cancel</button>\n<button data-toggle=\'accept_for_everyone\' type=\'button\' class=\'btn\'>Delete For Everyone</button></p>\n</div>';}return __p};
this["FirechatDefaultTemplates"]["templates/prompt-message-delete.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<p class="clearfix">\n<button data-toggle="accept_for_me" type="button" class="btn">Delete For Me</button>\n<button data-toggle="decline" type="button" class="btn">Cancel</button>\n'; if (deleteType != '2') { ;__p += '\n<button data-toggle="accept_for_everyone" type="button" class="btn">Delete For Everyone</button>\n'; } ;__p += '\n</p>\n</div>';}return __p};
...
this["FirechatDefaultTemplates"]["templates/tab-content.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'' +__e( id ) +'\' data-room-id=\'' +__e( id ) +'\' class=\'tab-pane\'>\n</div><div class=\'clearfix\'>\n<div id=\'firechat-messages' +__e( id ) +'\' class=\'chat\'></div>\n</div><div class=\'clearfix form-div\'>\n<label>Your message:</label>\n<form class="message-form" id="message-form' +__e( id ) +'" action="#">\n<textarea id=\'textarea' +__e( id ) +'\' placeholder=\'Type your message here...\'></textarea>\n<button type="button" id="sendMessage' +__e( id ) +'" title="Press to send message" class="btn btn-small sendMessage"><img width="18px" src="' + assetsImagePath + '/send.png" alt="Send"></button>\n</form>\n<form class="image-form" id="image-form' +__e( id ) +'" action="#">\n<input class="mediaCapture" id="mediaCapture' +__e( id ) +'" type="file" accept=".doc,.pdf,.xlsx,.docx,.txt,image/*,capture=camera" multiple>\n<button type="button" id="submitImage' +__e( id ) +'" title="Add an image" class="btn btn-small">\n<img width="18px" src="' + assetsImagePath + '/attach.png" alt="Attachments"></button>\n</form>\n</div>\n</div>';}return __p};

//this["FirechatDefaultTemplates"]["templates/tab-menu-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<li data-room-id=\'' +__e( id ) +'\'>\n<a href=\'#' +__e( id ) +'\' data-toggle=\'firechat-tab\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</a>\n<div class="firechat-dropdown-header aligncenter clearfix">\n<div class="search-wrapper">\n<span class="icon search"></span>\n<input type="text" class="center fivesixth searchChatMessage" placeholder="Enter keyword to search" />\n</div>\n</div>\n</li>';}return __p};
this["FirechatDefaultTemplates"]["templates/tab-menu-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<li data-room-id=\'' +__e( id ) +'\'>\n<a class=\'hidden\' href=\'#' +__e( id ) +'\' data-toggle=\'firechat-tab\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</a>\n<div class="firechat-dropdown-header aligncenter clearfix">\n<div class="search-wrapper">\n<span class="icon search"></span>\n<input type="text" class="center fivesixth searchChatMessage" placeholder="Enter keywords to search" />\n</div>\n</div>\n</li>';}return __p};
...
(function() {
  ...
  Firechat.prototype = {
    ...
    _onUpdateMessage: function(roomId, snapshot) {
      var message = snapshot.val();
      message.id = snapshot.key;
      this._invokeEventCallbacks('message-changed', roomId, message);
    },
  ...
  Firechat.prototype.enterRoom = function(roomId) {
    ...
    self.getRoom(roomId, function(room) {
      var roomName = room != null ? room.name : "";
      ...
      self._roomRef.child(roomId).once('value', function(snapshot) {
        ...
        self._messageRef.child(roomId).on('child_changed', function(snapshot) {
          self._onUpdateMessage(roomId, snapshot);
        }, /* onCancel */ function(){}, /* context */ self);
  ...
  Firechat.prototype.sendMessage = function(roomId, messageContent, messageType, cb) {
    var self = this,
        message = {
          ...
          status: 'Yes',
          messageDelete: '0'    // 0=>cancel ,1=>delete_for_me ,2=>delete for
        },
        newMessageRef;
    if (!self._user) {
    ...
    if(typeof roomName !== "undefined"){
        var messageId = newMessageRef.path.n[3];
        var tabulatorUrl = window.location.href;
        var postData = {'title':roomName,'message':messageContent,'tabulatorUrl':tabulatorUrl,"firebase_room_id":roomId,"messageId":messageId};
        sendChatFiberNotificaton(BASE_URL + '/users/sendChatFiberNotificaton',postData);
    }
    newMessageRef.setWithPriority(message, firebase.database.ServerValue.TIMESTAMP, cb);
  };
  //New for update message
    Firechat.prototype.editMessage = function(roomId, messageId, messageArr, cb) {
        var self = this,
                message = messageArr,
                newMessageRef;
                if (!self._user) {
        ...
        self._messageRef.child(roomId).child(messageId).update(message, cb);
    };
  //end
...
(function($) {
  ...
  FirechatUI.prototype = {
    ...
    _bindUIEvents: function() {
      ...
      this._bindForMessageEdit();
      this._bindForMessageDelete();
    ...
    _bindDataEvents: function() {
      ...
      this._chat.on('message-changed', this._onUpdateMessage.bind(this));
    ...
    $('#firechat-btn-rooms').bind('click', function() {
      ...
      self._chat.getRoomList(function(rooms) {
        ...
        for (var roomId in rooms) {
          ...
          if (room.type != "public" || typeof self.$messages[room.id] === 'undefined') continue;
  ...
  FirechatUI.prototype._bindForMessageDelete = function() {
    var self = this;
    $(document).delegate('a.delteIcon', 'click', function(event) {
      var $this = $(this),
          messageId = $this.closest('[data-user-id]').attr('data-message-id'),
          roomId = $this.closest('[data-user-id]').parents('.tab-content').find('.tab-pane.active').attr('data-room-id'),
          template = FirechatDefaultTemplates["templates/prompt-message-delete.html"],
          message = $this.closest('[data-user-id]').find('.message-content').text(),
          status = $this.closest('[data-user-id]').attr('data-message-status'),
          deleteType = $this.closest('[data-user-id]').attr('data-message-delete'),
          type = $this.closest('[data-user-id]').attr('class');

        event.preventDefault();
        type = type.split('-')[1] || "default";
        var $prompt = self.prompt('Delete Message?', template({
        ...
        $prompt.find('[data-toggle=accept_for_everyone]').first().click(function() {
//            self._chat.deleteMessage(roomId, messageId);
                var messageArr = {
//                    userId: self._user.id,
//                    name: self._user.name,
                    timestamp: firebase.database.ServerValue.TIMESTAMP,
//                    message: (deleteType != "2" && message!="" ? message.replace(/\s/g,'') : ""),
//                    type: type || 'default',
                    status: status || 'No',
                    messageDelete: '2'
                };
            self._chat.editMessage(roomId,messageId, messageArr);
            $this.closest('[data-user-id]').attr('data-message-delete','2').attr('style','color:#333 !important');
            $this.closest('div').find('a.editIcon').remove();
            $this.closest('[data-user-id]').find('.message-content').html('This message was deleted.');
            $prompt.remove();
            return false;
        });
        
        $prompt.find('[data-toggle=accept_for_me]').first().click(function() {
            type = type.split('-')[1] || "default";
            var messageArr = {
//                    userId: self._user.id,
//                    name: self._user.name,
...
//                    message: (deleteType != "2" && message!="" ? message.replace(/\s/g,'') : ""),
//                    type: type || 'default',
                    status: (typeof deleteType !== 'undefined' && deleteType == '2') ? 'Deleted' : (typeof status !== 'undefined' ? status : 'No'),
                    messageDelete: '1'
                };
            self._chat.editMessage(roomId,messageId, messageArr);
            $this.closest('[data-user-id]').remove();
            $prompt.remove();
            return false;
        });
    });
  };
  FirechatUI.prototype._bindForMessageEdit = function() {
    var self = this;
    $(document).delegate('a.editIcon', 'click', function(event) {
        var $this = $(this),
          messageId = $this.closest('[data-user-id]').attr('data-message-id'),
          roomId = $this.closest('[data-user-id]').parents('.tab-content').find('.tab-pane.active').attr('data-room-id'),
          template = FirechatDefaultTemplates["templates/prompt-message-edit.html"],
          message = $this.closest('[data-user-id]').find('.message-content').html().trim(),
          message = $this.closest('[data-user-id]').find('.message-content').html().trim().replace(/<br *\/?>/gi,'\n'),
          type = $this.closest('[data-user-id]').attr('class'),
          status = $this.closest('[data-user-id]').attr('data-message-status'),
          deleteType = $this.closest('[data-user-id]').attr('data-message-delete'),
        ...
        event.preventDefault();
        var $prompt = self.prompt('Edit Message here!', template({
          message: message
        }));
        $prompt.find('a.close').first().click(function() {
          $prompt.remove();
        ...
        $prompt.find('[data-toggle=accept]').first().click(function() {
            newMessage = $.trim($(this).closest('div').find('textarea').val());
            var s_newMessage = self.trimWithEllipsis(newMessage, self.maxLengthMessage)
            type = type.split('-')[1] || "default";
            var messageArr = {
//                    userId: self._user.id,
//                    name: self._user.name,
                    timestamp: firebase.database.ServerValue.TIMESTAMP,
                    message: (deleteType != "2" && newMessage!="" ? s_newMessage : ""),
                    type: 'default',
//                    status: status || 'No',
                    messageDelete: '0'
                };
                var statusSend = status || 'No';
            updateValue(roomId,messageId,messageArr.message,statusSend );
            self._chat.editMessage(roomId,messageId, messageArr);
            $this.closest('[data-user-id]').find('.message-content').html(newMessage.replace(/\n/g,'<br>'))
            $prompt.remove();
            return false;
        });
  ...
  FirechatUI.prototype.attachTab = function(roomId, roomName) {
    ...
    var $sendMessage = $tabContent.find('textarea').first().parent().find('button.sendMessage');
    ...
    $sendMessage.on('click touch', function(event) {
        var message = self.trimWithEllipsis($textarea.val(), self.maxLengthMessage);
...
//      console.log(rawMessage)
    ...
    var message = {
      ...
      isSelfMessage   : (user && rawMessage.userId == user.uid),
      isSelfDeleted   : (typeof rawMessage.messageDelete !== "undefined") ? rawMessage.messageDelete : '0',
      disableActions  : (!user.uid || rawMessage.userId == user.uid)
    };
    ...
    if($.inArray( message.type, ['imageUri', 'docUri', 'chatNotify'] ) === -1) {
    ...
    else if(message.type == 'chatNotify') { // If the message is auto message.      
      message.message = message.message.replace(/\n/g,"<br>");
    }
    else if(message.type == 'docUri') { // If the message is a document.      
      message.message = '<a href="' + message.message.url + '" download>' + message.message.name + '</a>';
      if(message.message.note){
        message.message.note = self.trimWithEllipsis(message.message.note, self.maxLengthMessage);
        message.message.note = message.message.note.replace(/\n/g,"<br>");
        $(self.$messages[roomId]).find('div[data-message-id="'+message.id+'"] .message-content').append("<br>" + message.message.note);
      }
    }
    else if(message.type == 'imageUri' && message.isSelfDeleted === '0') { // If the message is an image.
      var image = document.createElement("img");
      image.setAttribute("src", 'https://www.google.com/images/spin-32.gif');

      image.addEventListener('load', function() {  
        if(image.getAttribute("src") !== message.message.thumb){
          image.setAttribute("src", message.message.thumb);
        }
        if(message.isSelfDeleted == '2'){
            image = "This message was deleted.";
        }
        $(self.$messages[roomId]).find('div[data-message-id="'+message.id+'"] .message-content').html(image);
        if(message.message.note){
          message.message.note = self.trimWithEllipsis(message.message.note, self.maxLengthMessage);
          message.message.note = message.message.note.replace(/\n/g,"<br>");
          $(self.$messages[roomId]).find('div[data-message-id="'+message.id+'"] .message-content').append("<br>" + message.message.note);
        }
        $(self.$messages[roomId]).find('div[data-message-id="'+message.id+'"] .message-content').find('img').wrap('<a target="_blank" href="' + message.message.url + '"></a>');

        self.$messages[roomId].scrollTop(self.$messages[roomId][0].scrollHeight);
      }.bind(this), true);

      image.addEventListener('error', function() {
        $(self.$messages[roomId]).find('div[data-message-id="'+message.id+'"] .message-content').html("This image has been removed.");
      });
    }
  ...
  FirechatUI.prototype.updateMessage = function(roomId, rawMessage) {
        ...
        updateValue(roomId,message.id,message.message,message.status);
        if(message.userId != user.uid){
            if(message.isSelfDeleted == "0"){
                $('.message[data-message-id="' + message.id + '"]').find('.message-content').html(message.message.replace(/\n/g,'<br>'));
            }
            if(message.isSelfDeleted == "2" || message.status == "Deleted"){
                $('.message[data-message-id="' + message.id + '"]').find('.message-content').html('This message was removed');
            }
                
            $('.message[data-message-id="' + message.id + '"]').attr('data-message-status',message.status);
            $('.message[data-message-id="' + message.id + '"]').attr('data-message-delete',message.isSelfDeleted);
        }        
  };
