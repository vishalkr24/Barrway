...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha = function(options) {
		...
		return this.each(function() {
			...
			// Find and disable the submit button
                        var $submit = opts.submitId ? $form.find(opts.submitId) : $form.find('button.btn[type=submit]');
	...
	$.fn.motionCaptcha.defaults = {
		...
		onSuccess: function($form, $canvas, ctx) {
			var opts = this,
				$submit = opts.submitId ? $form.find(opts.submitId) : $form.find('button.btn[type=submit]:disabled');
