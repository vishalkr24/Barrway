(function () {
    'use strict';
    FormGeneratorApp.controller('StudentRegisterFormMasterController', function ($scope, $rootScope, $filter, $http, $location, $window, mainService, adminService, $state, $stateParams, DataService, $timeout, notifierService, CookiesPersistenceService, $ngBootbox, translationService) {

        var tabulatorChildren = {};
        //var isSubscription = $scope.isSubscription($scope.formDetailsDataInfo.formId, "checkIfRequested");;
        $scope.init = function () {

            $scope.GetAdditionalFormId();
            ...
            $ngBootbox.hideAll();
            var formId = $scope.calendarDetails.ADDITIONAL_FORM_ID;
        ...
        $scope.GetAdditionalFormId = function () {
            $.ajax({
                type: "POST",
                url: BASE_URL + "MarketPlace/GetCalendarDetails/" + localStorage.getItem("CALENDAR_CODE"),
                contentType: "application/json",
                async: false,
                success: function (response) {
                    $scope.calendarDetails = response.Data
                    if ($scope.calendarDetails.ADDITIONAL_FORM_ID == null || $scope.calendarDetails.ADDITIONAL_FORM_ID == "" || $scope.calendarDetails.ADDITIONAL_FORM_ID == "null") {
                        window.location.replace("/calendar/index#/home");
                    } else {
        ...
        $scope.Toggle = function () {
            ...
            //$state.go('CalenderRecords', { formId: $scope.calendarDetails.ADDITIONAL_FORM_ID });
        ...
        $scope.chatRoom = function (roomid) {
            ...
            localStorage.setItem('chatRoomForm', $scope.calendarDetails.ADDITIONAL_FORM_ID);
            $state.go("chat");
            //var param={};
            //param.formId=$scope.calendarDetails.ADDITIONAL_FORM_ID;
            //param.roomid=roomid;
        ...
        $scope.onGroupByChange = function (data) {
            localStorage.setItem("records_" + $scope.calendarDetails.ADDITIONAL_FORM_ID, data.groupByRecord);
        ...
        $scope.bindDraggable = function () {
            var param1 = {};
            param1.action = 18;
            param1.formId = $scope.calendarDetails.ADDITIONAL_FORM_ID;;
        ...
        function bindtabulatorOnly(type, data) {
            ...
            if (localStorage.getItem("records_" + $scope.calendarDetails.ADDITIONAL_FORM_ID)) {
                $scope.filterBy.groupByRecord = localStorage.getItem("records_" + $scope.calendarDetails.ADDITIONAL_FORM_ID);
            }
