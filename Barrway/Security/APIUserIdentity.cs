...
{
    public static class APIUserIdentity
    {
        public static string UserName { get { return (HttpContext.Current.User as ClaimsPrincipal).Identity.Name; } }
        public static string Role
        {
            get
            {
                if (HttpContext.Current != null && (HttpContext.Current.User as ClaimsPrincipal) != null && (HttpContext.Current.User as ClaimsPrincipal).Identity!=null && !string.IsNullOrEmpty((HttpContext.Current.User as ClaimsPrincipal).Identity.Name)) {
                    var identity = (System.Security.Claims.ClaimsIdentity)(HttpContext.Current.User as ClaimsPrincipal).Identity;
